...
```mermaid
graph TD
    Start[00-README.md<br/>Point d'entrée] --> Debutant{Niveau?}
    
    Debutant -->|Débutant| D1[01-arbre_widgets.md]
    Debutant -->|Intermédiaire| D2[02-explication_streambuilder.md]
    Debutant -->|Avancé| D3[05-approche_critique.md]
    
    D1 --> D2
    D2 --> Eval1[EXAMEN 20Q]
    
    Eval1 --> Score{Score?}
    Score -->|< 12/20| Revision[Relire 02]
    Score -->|>= 12/20| Quiz[Quiz 30Q]
    
    Quiz --> D4[04-navigation_view_all.md]
    D4 --> D3
    
    D3 --> Cas[06-etudes_de_cas.md]
    
    Cas --> Expert[Niveau Expert]
    
    Start -->|Professeur| Prof[GUIDE_PROFESSEUR.md]
    Prof --> Corrige[EXAMEN_CORRIGE.md]
    Prof --> Synthese[SYNTHESE_15_CAS.md]
    
    Start -->|Décision rapide| Quick[DECISION_RAPIDE.md]
    
    style Start fill:#e1f5ff
    style Eval1 fill:#ffe1e1
